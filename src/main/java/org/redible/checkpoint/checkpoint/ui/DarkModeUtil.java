...
public class DarkModeUtil {
    public static void toggleDarkMode(boolean enable, JFrame parentFrame) {
        AppConfig.setDarkModeEnabled(enable);
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(parentFrame, "Hiba történt a kinézet frissítése során!", "Hiba", JOptionPane.ERROR_MESSAGE);
        }
    }
}
